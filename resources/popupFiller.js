function generatePopup(event){
    ...
    event.forEach(evt => {
        ...
        params.died100.confidenceHigh = Math.round(mortalita_100.tasso_sup * 10)
        params.died100.confidenceLow = Math.round(mortalita_100.tasso_inf * 10)
        params.died100.value = Math.round(mortalita_100.tasso * 10)
